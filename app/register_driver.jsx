      ...
      >
        ...
        >
          ...
          <View style={styles.bottomSection}>
            ...
            <View style={styles.inputWrapper}>
              <View style={styles.iconBox}><FontAwesome name="home" size={18} color="white" /></View>
            ...
            <View style={styles.footerRow}>
              ...
              <View style={styles.navButtons}>
                ...
                <TouchableOpacity style={styles.nextNavButton} onPress={() => router.push('/register_driver_2')}>
...
const styles = StyleSheet.create({
  ...
  logoBox: { backgroundColor: 'white', width: 250, height: 100, borderRadius: 15, justifyContent: 'center', alignItems: 'center', elevation: 8 },
