    ...
    >
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.passengerName}>Support Chat</Text>
        </View>
      </View>
      ...
      >
        <View style={styles.messageBoard}>
          <View style={styles.titleBanner}>
            <Text style={styles.titleText}>Chat Fleet Manager</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  passengerName: {  color: 'white', fontSize: 22, fontWeight: '500' },
  contentContainer: {
    flex: 1,
...
export default SupportChatDriver;