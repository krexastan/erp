  ...
  return (
    <View style={styles.bottomNavContainer}>
      <View style={styles.bottomNav}>
        ...
        >
          <Image
            source={require("../assets/erp/passenger/vehicle_white.png")}
        ...
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => router.push("/wallet_passenger")}
        >
          <Image
            source={require("../assets/erp/passenger/wallet_white.png")}
            style={styles.customIconNav}
          />
        </TouchableOpacity>
        ...
        >
          <Image
            source={require("../assets/erp/passenger/support_white.png")}
            style={styles.customIconNav}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => router.push("/dashboard_profile_passenger")}
        >
          <Image
